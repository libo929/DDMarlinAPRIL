/**
 *  @file   DDMarlinAPRIL/include/DDAPRILPFAProcessor.h
 * 
 *  @brief  Header file for the april pfa processor class.
 * 
 *  $Log: $
 */

#ifndef DDAPRILPFAPROCESSOR_H
#define DDAPRILPFAPROCESSOR_H 1
...
/**
 *  @brief  DDAPRILPFAProcessor class
 */
class DDAPRILPFAProcessor : public marlin::Processor
{
public:
    ...
    public:
        ...
        std::string     m_aprilSettingsXmlFile = "";      ///< The april settings xml file
     ...
     */
    DDAPRILPFAProcessor();
    DDAPRILPFAProcessor(const DDAPRILPFAProcessor&) = delete;
    DDAPRILPFAProcessor& operator=(const DDAPRILPFAProcessor&) = delete;
...
inline marlin::Processor *DDAPRILPFAProcessor::newProcessor()
{
    return new DDAPRILPFAProcessor;
}

#endif // #ifndef DDAPRILPFAPROCESSOR_H
