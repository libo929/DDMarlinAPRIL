/**
 *  @file   DDMarlinArbor/include/DDArborPFAProcessor.h
 * 
...
#ifndef DDARBORPFAPROCESSOR_H
#define DDARBORPFAPROCESSOR_H 1
...
/**
 *  @brief  DDArborPFAProcessor class
 */
class DDArborPFAProcessor : public marlin::Processor
{
public:
    ...
    public:
        ...
        std::string     m_arborSettingsXmlFile = "";      ///< The arbor settings xml file
     ...
     */
    DDArborPFAProcessor();
    DDArborPFAProcessor(const DDArborPFAProcessor&) = delete;
    DDArborPFAProcessor& operator=(const DDArborPFAProcessor&) = delete;
...
inline marlin::Processor *DDArborPFAProcessor::newProcessor()
{
    return new DDArborPFAProcessor;
}

#endif // #ifndef DDARBORPFAPROCESSOR_H
